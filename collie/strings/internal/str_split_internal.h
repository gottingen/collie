...
namespace collie::strings_internal {
...
// or an std::initializer_list<T>).
    ...
    struct SplitterIsConvertibleTo
            : SplitterIsConvertibleToImpl<C,
                    ...
                    HasConstIterator<C>::value, HasMappedType<C>::value> {
    };

    // This class implements the range that is returned by collie::str_split(). This
