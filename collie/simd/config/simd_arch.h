...
namespace collie::simd {
    ...
    namespace detail {
        ...
        class dispatcher {
            ...
            inline auto walk_archs(arch_list<Arch>, Tys &&... args) noexcept -> decltype(functor(Arch{},
                                                                                                 std::forward<Tys>(
                                                                                                         args)...)) {
            ...
            inline auto
            walk_archs(arch_list<Arch, ArchNext, Archs...>, Tys &&... args) noexcept -> decltype(functor(Arch{},
                                                                                                         std::forward<Tys>(
                                                                                                                 args)...)) {
        ...
        public:
            ...
            template<class... Tys>
            inline auto
            operator()(Tys &&... args) noexcept -> decltype(functor(default_arch{}, std::forward<Tys>(args)...)) {
