...
static std::string log_to_str(const std::string &msg, const Args &... args) {
    ...
    collie::log::logger oss_logger("pattern_tester", oss_sink);
    oss_logger.set_level(collie::log::level::info);

    oss_logger.set_formatter(std::unique_ptr<collie::log::formatter>(new collie::log::pattern_formatter(args...)));
...
TEST_CASE("custom eol [pattern_formatter]")
{
    ...
    std::string eol = ";)";
    REQUIRE(log_to_str(msg, "%v", collie::log::pattern_time_type::local, ";)") == msg + eol);
}

TEST_CASE("empty format [pattern_formatter]")
{
    REQUIRE(log_to_str("Some message", "", collie::log::pattern_time_type::local, "").empty());
}

TEST_CASE("empty format2 [pattern_formatter]")
{
    REQUIRE(log_to_str("Some message", "", collie::log::pattern_time_type::local, "\n") == "\n");
}

TEST_CASE("level [pattern_formatter]")
{
    REQUIRE_EQ(log_to_str("Some message", "[%l] %v", collie::log::pattern_time_type::local, "\n"),
               "[info] Some message\n");
}

TEST_CASE("short level [pattern_formatter]")
{
    REQUIRE(log_to_str("Some message", "[%L] %v", collie::log::pattern_time_type::local, "\n") == "[I] Some message\n");
}

TEST_CASE("name [pattern_formatter]")
{
    REQUIRE(log_to_str("Some message", "[%n] %v", collie::log::pattern_time_type::local, "\n") ==
...
TEST_CASE("date MM/DD/YY  [pattern_formatter]")
{
    ...
    REQUIRE(log_to_str("Some message", "%D %v", collie::log::pattern_time_type::local, "\n") == oss.str());
}

TEST_CASE("color range test1 [pattern_formatter]")
{
    auto formatter = std::make_shared<collie::log::pattern_formatter>("%^%v%$", collie::log::pattern_time_type::local,
                                                                      "\n");
    ...
    collie::log::details::log_msg msg(logger_name, collie::log::level::info,
                                      std::string_view(buf.data(), buf.size()));
    formatter->format(msg, formatted);
    REQUIRE_EQ(msg.color_range_start , 0);
    REQUIRE_EQ(msg.color_range_end , 5);
    REQUIRE_EQ(log_to_str("hello", "%^%v%$", collie::log::pattern_time_type::local, "\n") , "hello\n");
}

TEST_CASE("color range test2 [pattern_formatter]")
{
    auto formatter = std::make_shared<collie::log::pattern_formatter>("%^%$", collie::log::pattern_time_type::local,
                                                                      "\n");
    std::string logger_name = "test";
    collie::log::details::log_msg msg(logger_name, collie::log::level::info, "");
    memory_buf_t formatted;
    ...
    REQUIRE_EQ(log_to_str("", "%^%$", collie::log::pattern_time_type::local, "\n") , "\n");
}

TEST_CASE("color range test3 [pattern_formatter]")
{
    auto formatter = std::make_shared<collie::log::pattern_formatter>("%^***%$");
    std::string logger_name = "test";
    collie::log::details::log_msg msg(logger_name, collie::log::level::info, "ignored");
    memory_buf_t formatted;
    formatter->format(msg, formatted);
    REQUIRE_EQ(msg.color_range_start , 0);
...
{
    auto formatter = std::make_shared<collie::log::pattern_formatter>("XX%^YYY%$",
                                                                      collie::log::pattern_time_type::local, "\n");
    std::string logger_name = "test";
    collie::log::details::log_msg msg(logger_name, collie::log::level::info, "ignored");
    ...
    REQUIRE_EQ(msg.color_range_end , 5);
    REQUIRE_EQ(log_to_str("ignored", "XX%^YYY%$", collie::log::pattern_time_type::local, "\n") , "XXYYY\n");
}
...
{
    REQUIRE(log_to_str("Some message", "[%8l] %v", collie::log::pattern_time_type::local, "\n") ==
            "[    info] Some message\n");
    REQUIRE(log_to_str("Some message", "[%8!l] %v", collie::log::pattern_time_type::local, "\n") ==
            "[    info] Some message\n");
}
...
{
    REQUIRE(log_to_str("Some message", "[%3L] %v", collie::log::pattern_time_type::local, "\n") ==
            "[  I] Some message\n");
    REQUIRE(log_to_str("Some message", "[%3!L] %v", collie::log::pattern_time_type::local, "\n") ==
            "[  I] Some message\n");
}
...
{
    REQUIRE(log_to_str("Some message", "[%3n] %v", collie::log::pattern_time_type::local, "\n") ==
            "[pattern_tester] Some message\n");
    REQUIRE(log_to_str("Some message", "[%3!n] %v", collie::log::pattern_time_type::local, "\n") ==
            "[pat] Some message\n");
}
...
{
    REQUIRE(log_to_str("Some message", "[%-300n] %v", collie::log::pattern_time_type::local, "\n") ==
            "[pattern_tester                                                  ] Some message\n");

    REQUIRE(log_to_str("Some message", "[%-300!n] %v", collie::log::pattern_time_type::local, "\n") ==
            "[pattern_tester                                                  ] Some message\n");
}

TEST_CASE("left_padded_max [pattern_formatter]")
{
    REQUIRE(log_to_str("Some message", "[%-64n] %v", collie::log::pattern_time_type::local, "\n") ==
            "[pattern_tester                                                  ] Some message\n");

    REQUIRE(log_to_str("Some message", "[%-64!n] %v", collie::log::pattern_time_type::local, "\n") ==
            "[pattern_tester                                                  ] Some message\n");
}
...
{
    REQUIRE(log_to_str("123456", "%6!v", collie::log::pattern_time_type::local, "\n") == "123456\n");
    REQUIRE(log_to_str("123456", "%5!v", collie::log::pattern_time_type::local, "\n") == "12345\n");
    REQUIRE(log_to_str("123456", "%7!v", collie::log::pattern_time_type::local, "\n") == " 123456\n");
    ...
    REQUIRE(log_to_str("123456", "%0!v", collie::log::pattern_time_type::local, "\n") == "\n");
}

TEST_CASE("padding_truncate_funcname [pattern_formatter]")
{
    collie::log::sinks::test_sink_st test_sink;

    const char *pattern = "%v [%5!!]";
    auto formatter = std::unique_ptr<collie::log::formatter>(new collie::log::pattern_formatter(pattern));
    test_sink.set_formatter(std::move(formatter));

    collie::log::details::log_msg msg1{collie::log::source_loc{"ignored", 1, "func"}, "test_logger",
                                       collie::log::level::info, "message"};
    test_sink.log(msg1);
    REQUIRE_EQ(test_sink.lines()[0], "message [ func]");

    collie::log::details::log_msg msg2{collie::log::source_loc{"ignored", 1, "function"}, "test_logger",
                                       collie::log::level::info, "message"};
    test_sink.log(msg2);
...
TEST_CASE("padding_funcname [pattern_formatter]")
{
    ...
    collie::log::details::log_msg msg2{collie::log::source_loc{"ignored", 1, "func567890123"}, "test_logger",
                                       collie::log::level::info, "message"};
    test_sink.log(msg2);
...
{
    auto formatter_1 = std::make_shared<collie::log::pattern_formatter>();
    auto formatter_2 = formatter_1->clone();
    std::string logger_name = "test";
    collie::log::details::log_msg msg(logger_name, collie::log::level::info, "some message");
...
{
    auto formatter_1 = std::make_shared<collie::log::pattern_formatter>("%D %X [%] [%n] %v");
    auto formatter_2 = formatter_1->clone();
    std::string logger_name = "test";
    collie::log::details::log_msg msg(logger_name, collie::log::level::info, "some message");
...
{
    using collie::log::pattern_time_type;
    auto formatter_1 = std::make_shared<collie::log::pattern_formatter>("%D %X [%] [%n] %v", pattern_time_type::utc,
                                                                        "xxxxxx\n");
    auto formatter_2 = formatter_1->clone();
...
class custom_test_flag : public collie::log::custom_flag_formatter {
public:
    explicit custom_test_flag(std::string txt)
            : some_txt{std::move(txt)} {}

    void format(const collie::log::details::log_msg &, const turbo::CivilInfo &tm, collie::log::memory_buf_t &dest) override {
        if (some_txt == "throw_me") {
            throw collie::log::tlog_ex("custom_flag_exception_test");
    ...
    collie::log::details::padding_info get_padding_info() {
        return padinfo_;
    }
    ...
    std::unique_ptr<custom_flag_formatter> clone() const override {
        return collie::log::details::make_unique<custom_test_flag>(some_txt);
    }
};
...
TEST_CASE("clone-custom_formatter [pattern_formatter]")
{
    ...
    auto expected = turbo::format("[logger-name] [custom_output] some message{}",
                                                 collie::log::details::os::default_eol);
...
{
    collie::log::pattern_formatter formatter("%s", collie::log::pattern_time_type::local, "");
    memory_buf_t formatted;
    std::string logger_name = "logger-name";
    collie::log::source_loc source_loc{test_path, 123, "some_func()"};
    collie::log::details::log_msg msg(source_loc, "logger-name", collie::log::level::info, "Hello");
    formatter.format(msg, formatted);
...
TEST_CASE("short filename formatter-2 [pattern_formatter]")
{
    ...
    memory_buf_t formatted;
    std::string logger_name = "logger-name";
    collie::log::source_loc source_loc{"myfile.cpp", 123, "some_func()"};
    collie::log::details::log_msg msg(source_loc, "logger-name", collie::log::level::info, "Hello");
    formatter.format(msg, formatted);
...
{
    collie::log::pattern_formatter formatter("%s %v", collie::log::pattern_time_type::local, "");
    memory_buf_t formatted;
    std::string logger_name = "logger-name";
    collie::log::source_loc source_loc{"", 123, "some_func()"};
    collie::log::details::log_msg msg(source_loc, "logger-name", collie::log::level::info, "Hello");
    formatter.format(msg, formatted);
...
{
    collie::log::pattern_formatter formatter("%g", collie::log::pattern_time_type::local, "");
    memory_buf_t formatted;
    std::string logger_name = "logger-name";
    collie::log::source_loc source_loc{test_path, 123, "some_func()"};
    collie::log::details::log_msg msg(source_loc, "logger-name", collie::log::level::info, "Hello");
...
TEST_CASE("custom flags [pattern_formatter]")
{
    ...
    collie::log::details::log_msg msg(collie::log::source_loc{}, "logger-name", collie::log::level::info,
                                      "some message");
    formatter->format(msg, formatted);
...
TEST_CASE("custom flags-exception [pattern_formatter]")
{
    ...
    collie::log::details::log_msg msg(collie::log::source_loc{}, "logger-name", collie::log::level::info,
                                      "some message");
    CHECK_THROWS_AS(formatter->format(msg, formatted), collie::log::tlog_ex);
}
