...
elseif (${PRETTY_NAME} MATCHES "darwin")
    ...
    set(CARBIN_PACKAGE_SYSTEM_NAME "darwin-${DISTRO_VERSION_ID}")
    set(HOST_SYSTEM_NAME "dmg")
elseif (${PRETTY_NAME} MATCHES "CentOS")
    MESSAGE(STATUS "Linux dist: centos")
    set(CARBIN_PACKAGE_SYSTEM_NAME "centos-${DISTRO_VERSION_ID}")
    set(HOST_SYSTEM_NAME "rpm")
endif ()
